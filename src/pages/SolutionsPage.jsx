...
const sections = [
  {
    ...
    copy: "Reps rehearse the exact calls they'll make this quarter — with an AI buyer that pushes back in the dialect your market speaks — and ramp in weeks, not months.",
    ...
    items: [
      [
        "Cold Calling",
        "Openings, objections, and keeping prospects engaged past the first minute.",
      ],
      [
        "Discovery Calls",
        "Sharper questioning, active listening, and qualification skills.",
      ],
      [
        "Closing Deals",
        "Negotiation, stakeholder alignment, and closing conversations.",
      ],
    ],
  },
  {
    ...
    copy: "Agents face the angriest customer they'll ever meet — before they meet one. High-pressure practice that shows up as calmer calls and higher CSAT.",
    ...
    items: [
      ...
      [
        ...
        "Practice high-pressure conversations before they reach a real customer.",
      ],
      [
        "Service Recovery",
        "Navigate difficult interactions and keep customers from walking away.",
      ],
    ],
  },
  {
    ...
    copy: "Feedback, coaching, and accountability conversations are the ones managers avoid. Rehearsing them privately makes them happen - and land.",
    ...
    items: [
      [
        "Giving Feedback",
        "Constructive, performance-based feedback conversations.",
      ],
      [
        "Coaching Employees",
        "Development discussions that move people forward.",
      ],
      [
        "Difficult Conversations",
        "Accountability, conflict, and performance issues — handled with steadiness.",
      ],
    ],
  },
  {
    ...
    copy: "Engineers and specialists practice explaining technical decisions to clients, executives, and other teams — until clarity is the default.",
    ...
    items: [
      ...
      [
        ...
        "Customer-facing technical discussions and demos.",
      ],
      [
        "Cross-Functional Collaboration",
        "Better communication with product, sales, and leadership teams.",
      ],
    ],
  },
  {
    ...
    copy: "AI runs structured first-round interviews on the candidate's schedule; your team reviews scored, human-verified notes and decides. No scheduler bottleneck.",
    ...
    items: [
      [
        ...
        "Structured first rounds any time — no candidate waits on a scheduler.",
      ],
      [
        "Admissions & Recruiter Screening",
        "Consistent interviews across intakes and hiring pipelines at scale.",
      ],
      [
        "Human-Reviewed Scoring",
        "Every interview returns structured notes and competency signals for your team.",
      ],
    ],
  },
];
    ...
    >
      <Box
        sx={{
          ...
          gridTemplateColumns: {
            xs: "1fr",
            lg: "minmax(0, 1fr) minmax(0, 1.15fr)",
          },
          gap: { xs: 3.5, md: 5.5 },
          alignItems: "center",
          mb: 4.5,
      ...
      >
        {section.items.map(([title, copy]) => (
          ...
          >
            <Typography
              variant="h3"
              sx={{ fontWeight: 700, fontSize: 21, mb: 0.75 }}
            >
              {title}
            </Typography>
            <Typography
  ...
  return (
    ...
    >
      <Box
        sx={{
          background: "#F7F9E8",
          borderBottom: "1px solid rgba(22,55,31,.08)",
        }}
      >
        <Container
          maxWidth={false}
        ...
        >
          <Box>
            ...
            >
              From the deals you close to the candidates you screen — practice,
              measure, and improve the conversations that move your business. In
      ...
      <Box id="cta" sx={{ background: "#16371F", scrollMarginTop: "80px" }}>
        ...
        >
          <Box>
            ...
            >
              Train the moments your business cannot afford to{" "}
              <span>improvise</span>
            </Typography>
            <Typography
              sx={{
            ...
            >
              Built for roleplay training and structured assessment across
              Arabic-speaking teams — in the dialects your customers actually
              speak.
            </Typography>
          ...
          >
            {localizedCtaMetrics.map(([value, label], index) => (
              ...
              >
                ...
                <Typography
                  sx={{ fontSize: 13, color: "rgba(246,247,232,.65)", mt: 0.6 }}
                >
                  {label}
                </Typography>
              </Box>
